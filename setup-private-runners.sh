...
export SUBSCRIPTION_ID="<Azure Subscription ID>" #3Cloud ASD Lab Subscription ID
export RESOURCE_GROUP_NAME="<Azure Resource Group>"
export VNET_NAME="<Azure VNet Name>"
export SUBNET_NAME="<Azure Subnet Name>"
export NSG_NAME="<Azure Network Security Group Name>"
export NETWORK_SETTINGS_RESOURCE_NAME="<Azure Network Setting Resource Name>"
export DATABASE_ID="GitHub Database ID"
